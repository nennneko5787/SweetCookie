...
import net.nennneko5787.lepus.core.registry.ActiveJson;
...
public final class WorldActivation {
    ...
    public static Optional<ActivePacks> update(UnaryOperator<ActivePacks> change) {
        ...
        try {
            ...
            System.out.println("[Lepus] could not write " + ActiveJson.FILE_NAME
    ...
    private static void load(Path worldData) {
        ...
        try {
            ...
            current = ActivePacks.NONE;
            System.out.println("[Lepus] could not read " + ActiveJson.FILE_NAME
