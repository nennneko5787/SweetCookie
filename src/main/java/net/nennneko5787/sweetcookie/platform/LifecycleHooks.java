 ...
 * {@code <world>/data/sweetcookie/ledger.json}, so it must be read once the save directory exists
...
public interface LifecycleHooks {
    ...
    interface ServerScope {
        ...
        /**
         * The world's data directory, {@code <world>/data/sweetcookie}, created if absent.
         *
