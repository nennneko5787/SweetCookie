...
import net.nennneko5787.lepus.core.format.manifest.Capability;
import net.nennneko5787.lepus.core.format.manifest.Manifest;
import net.nennneko5787.lepus.core.format.manifest.PackDependency;
import net.nennneko5787.lepus.core.format.manifest.PackHeader;
import net.nennneko5787.lepus.core.format.manifest.PackModule;
import net.nennneko5787.lepus.core.format.text.Localisation;
